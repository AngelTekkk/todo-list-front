        ...
        <header className={s.header}>
            ...
            <nav>
                <ul className={s.navList}>
                    <li className={s.navPoint}><a className={s.navLink} href='/todos'>MY TODO'S</a></li>
                    <li className={s.navPoint}><a className={s.navLink} href='/projects'>PROJECTS</a></li>
                    <li className={s.navPoint}><a className={s.navLink} href='/curriculum'>CURRICULUM</a></li>
                    <li className={s.navPoint}><a className={s.navLink} href='/completed'>COMPLETED</a></li>
                </ul>
            </nav>
